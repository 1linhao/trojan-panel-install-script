...
PANEL_IMAGE="${PANEL_IMAGE:-ghcr.io/1linhao/trojan-panel:test}"
UI_IMAGE="${UI_IMAGE:-ghcr.io/1linhao/trojan-panel-ui:test}"
CORE_IMAGE="${CORE_IMAGE:-ghcr.io/1linhao/trojan-panel-core:test}"
